...
//     echo "oginStrGroup=".$loginStrGroup."<br>";
//     echo "loginStrType=".$loginStrType."<br>";
//     echo "loginStrId=".$loginStrId."<br>";
//     die();
 ...
 <!--<a href="menberis1.php">--><img src="images/sign_t.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        ...
        <?php if(date('y-m-d')>= $publishDate){?>
  			<a href="./file/20170412180049.pdf"><img src="images/106schedule_t.png" /></a>
  		<?php }else { ?> <img src="images/106schedule_t.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){?>
         	<a href="./file/20170412180043.pdf"><img src="images/flow_t.png"  /></a>
...
<!-- 師資生連結 -->
 ...
 <!--<a href="menberis1.php">--><img src="images/sign.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
        <?php if(date('y-m-d')>= $publishDate){?>
  			<a href="./file/20170302180056.pdf"><img src="images/106schedule.png" /></a>
  		<?php }else { ?> <img src="images/106schedule.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){?>
         	<a href="./file/20170302180032.pdf"><img src="images/flow.png"  /></a>
...
<div id="dlg" class="easyui-dialog" closed="true" title="簡章下載" style="width:200px;height:150px;padding:10px"
						...
						">
	<a href="./file/20170302180026.pdf" class="easyui-linkbutton" >師資生簡章</a><a href="./file/20170412180036.pdf" class="easyui-linkbutton" >國小教師簡章</a>
</div>
