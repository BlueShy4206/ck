      ...
      <table width="540" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
          ...
          <td width="458" align="left" class="board_add"><label>
            ...
            <input name="eng_uname" type="<?php if($row_web_member['eng_uname'] =="") echo 'text'; else echo 'hidden';?>" id="eng_uname" value="<?php echo $row_web_member['eng_uname']; ?>" />            
          </label></td>
        </tr>        
        <tr>
          ...
          <td width="458" align="left" class="board_add"><label>
            ...
            <input name="uid" type="<?php if($row_web_member['uid'] =="") echo 'text'; else echo 'hidden';?>" id="uid" value="<?php echo $row_web_member['uid']; ?>" />              
          </label></td>
        </tr>        
        <tr>
