...
// 	echo "ins_High_college=".$degreeArray[$maxlevel][3]."<br>";
// 	die();
		...
		High_college,Sec_college,Other1_college,Other2_college, cert_id,examyear_id) 
 		...
 		%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
			%s,%s,%s,%s,%s,%s)",
					   ...
					   GetSQLValueString($_POST['id'], "text"),//add by coway 2016.8.9
					   GetSQLValueString($degreeArray[$maxlevel][3], "text"),//add by coway 2016.8.18
					   GetSQLValueString($degreeArray[$maxlevel-1][3], "text"),//add by coway 2016.8.18
					   GetSQLValueString($degreeArray[$maxlevel-2][3], "text"),//add by coway 2016.8.18
					   GetSQLValueString($degreeArray[$maxlevel-3][3], "text"),//add by coway 2016.8.18
...
<div id="main">
  ...
  <? if(strtotime($row_web_new['startday']) <= strtotime(date('Y-m-d')) && strtotime(date('Y-m-d')) <= strtotime($row_web_new['endday']) && $row_web_new['status'] == '1'){?>
  <? if(($row_web_examinee['username'] != $row_web_member['username']) or  strtotime(substr(($row_web_examinee['date']),0,10)) < (strtotime($row_web_new['startday']))){?>
    ...
    <form id="form3" name="form3" method="post" enctype="multipart/form-data" action="<?php echo $editFormAction; ?>" >
      ...
      <table width="540" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
          <td height="30" align="right" class="board_add">報考資格：<br>錄取順序一.<br>錄取順序二.<br>錄取順序三.</td>
           <td align="left" class="board_add" colspan="3">
          <label>本評量報考資格分為三類，其錄取順序如下：<br>
          	<input <?php if (!(strcmp($row_web_examinee2['cert_no'],"1"))) {echo "checked=\"checked\"";} ?> name="id" type="radio" id="radio1" value="1"  onclick="popIdMsg();" />
        ...
        <tr>
          ...
          <td align="left" class="board_add" colspan="3">
           <label>
            ...
            <input name="certificate" type="text" id="certificate" value="<?php echo $row_web_examinee2['certificate']; ?>" /> <!-- onclick="ShowAlert()" -->
    ...
    <!--    <tr>
        ...
        <tr>
          ...
          <td align="left" class="board_add" width="10">
          
          <span> 
          <br>       
          <input type="text" name="Other2_college" id="Other2_college" value="<?php echo $row_web_examinee2['Other2_college']; ?>"/>
          <span class="textfieldRequiredMsg">請輸入學院</span><span class="textfieldMinCharsMsg">請輸入學院</span></span>
          </td>
          <td align="left" class="board_add" width="30">
        ...
        <tr>
          ...
          <br>           
          <input type="text" name="High_college" id="High_college" value="<?php echo $row_web_examinee2['High_college']; ?>"/>
          <span class="textfieldRequiredMsg">請輸入學院</span><span class="textfieldMinCharsMsg">請輸入學院</span></span>
          </td>
          <td align="left" class="board_add">
        ...
        <tr>
          ...
          <span>          
          <br>   
          <input type="text" name="Sec_college" id="Sec_college"  value="<?php echo $row_web_examinee2['Sec_college']; ?>"/>
          <span class="textfieldRequiredMsg">請輸入學院</span><span class="textfieldMinCharsMsg">請輸入學院</span></span>
          </td>
          <td align="left" class="board_add">
        ...
        <tr>
          ...
          <span>          
          <br>   
          <input type="text" name="Other1_college" id="Other1_college"  value="<?php echo $row_web_examinee2['Other1_college']; ?>"/>
          <span class="textfieldRequiredMsg">請輸入學院</span><span class="textfieldMinCharsMsg">請輸入學院</span></span>
          </td>
          <td align="left" class="board_add">
