...
if($row_web_examinee['status']==0){
	$pdf_title = '105年第一梯次師資生';
}else $pdf_title = '105年第一梯次國民小學教師';
...
$pdf->SetFont('msungstdlight', '', 20, '', true);//使用者端電腦的預設字型
...
<style type='text/css'>			
 ...
 .footer {
	...
	font-size: 10pt;
		...
		<tr>
			<td align='center' colspan='4'><span style='font-size: 30px;'>&nbsp;<br/></span><font size='+3' >$pdf_title<br>$subjectTest 學科知能評量</font></td>
		</tr>
		<tr>
