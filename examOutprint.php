...
<div id="main111" background= "#FFFFFF">
 ...
 if(strtotime($row_web_new['printtime']) <= strtotime(date('Y-m-d H:i:s')) && strtotime(date('Y-m-d')) <= strtotime($exdate) 
 		&& $times1 == $row_web_new['times'] && $row_web_examinee['allow'] == "Y" &&($times2 == date('Y') or $times2 == $exyear)
...
if (!(strcmp($val,"4"))) {echo "自然領域";}} */ ?></td></tr> -->
       ...
       <tr>
          	...
          	<td align="left" class="board_add" style="font-size:18px; background-color: #FFFFFF; border-style:solid; border-color:#f3f3f3; border-width:1px;" colspan="2"><?php echo "自然領域";?></td>
       </tr>
       <tr>
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" > 
    	<tr>
          ...
          <p><font size="+2" ><strong>國民小學教師自然領域學科知能評量</strong></font></p>
            </td>
        </tr>
        <tr>  
          <td height="70" align="left"><font size="+1" >
          	‧應考人應攜帶自行列印之「<strong>准考證</strong>」及「<strong>國民身分證</strong>」正本（或以駕照、具照片之健保卡或尚未過期之有效護照代替國民身分證）到場應試。未能提供身分證明文件者，即取消應試資格，不得參加本次評量。應考人於評量當日無准考證者應攜帶本人身分證件至各考區試務中心辦理補發。未能提供身分證明文件者，如經監試委員查核確認係應考人本人無誤者，得先准予應試，惟身分證明文件至當日評量結束鈴（鐘）響畢前仍未送達者，則作答結果不予計分。
          </font></td>
