...
//-->
	...
	function ShowLink2(){
		...
		window.location.href = './file/20160325030145.doc';
	}
	function ShowLink3(){
		alert("確認後直接 下載 「知能評量證明書申請書」，謝謝。");
 ...
 <!--<a href="menberis1.php">--><img src="images/sign_t.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        ...
        <?php if(date('y-m-d')>= $publishDate){?>
  			<a href="./file/20160429030436.pdf"><img src="images/105schedule_t.png" /></a>
  		<?php }else { ?> <img src="images/105schedule_t.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){?>
         	<a href="./file/20160429031641.pdf"><img src="images/flow_t.png"  /></a>
...
<!-- 師資生連結 -->
    <table width="184" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="184" height="40" align="center" bgcolor="#FFFFFF"><img src="images/exam_information2.png" width="184" height="40" onmousemove="tbodyevent()"/></td>
      </tr>
		<script>
      	function tbodyevent(){
      ...
      <tr>
		...
		if($_SESSION['MM_Username'] != NULL){	
			if($_SESSION['MM_UserType'] =='0'){
					?>
		        <a href="examAdd.php" onclick="alert('提醒您：本梯次僅提供在學師資生報名，感謝您。')"><img src="images/sign.png" width="115"  height="67" /></a><br />
		<? }}else{?> <a href="index.php" onclick="alert('請先登入會員，再報名測驗。')">
 <!--<a href="menberis1.php">--><img src="images/sign.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
        <?php if(date('y-m-d')>= $publishDate){?>
  			<a href="./file/20160325021012.pdf"><img src="images/105schedule.png" /></a>
  		<?php }else { ?> <img src="images/105schedule.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){?>
         	<a href="./file/20160325020950.pdf"><img src="images/flow.png"  /></a>
...
<!--<a href="./file/20160420145740.pdf"><img src="images/download.gif"></a> -->
...
<div id="dlg" class="easyui-dialog" closed="true" title="簡章下載" style="width:200px;height:150px;padding:10px"
						...
						">
	<a href="./file/20160325015829.pdf" class="easyui-linkbutton" >師資生簡章</a><a href="./file/20160420145740.pdf" class="easyui-linkbutton" >國小教師簡章</a>
</div>
