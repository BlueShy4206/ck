...
$eng_uname=$_POST['Firstname']." ".str_replace(',','',trim(chop($_POST['Lastname'])));//add 去除前後空白.中間多個空白取代成一個.去除逗號,add by coway 2016.10.13
...
$result = $rs->execute(array($_POST['username'], $psw, $_POST['uname'], str_replace('  ',' ',$eng_uname) /*$_POST['eng_uname']*/, ucfirst($_POST['id']), $_POST['sex'], $_POST['birthday'], $_POST['email'], $_POST['orderPaper'], $_POST['phone'], $_POST['Area'], $_POST['cityarea'], $_POST['cuszip'], $_POST['cusadr'],  "member", $_POST['date']));
