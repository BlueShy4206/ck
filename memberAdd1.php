...
<div id="main_1">
  ...
  <div id="main_3" align="center" style="background:#efefef; margin: auto; width: 770px">
	...
	<form method="POST" action="insertMember.php" id="signupForm" onsubmit='return confirm("確定送出?");'>
      <? if($_GET["requsername"]!=""){?>
      ...
      <table width="540" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td width="458" align="left" class="board_add"><label for="uname"><input id="uname" name="uname" type="text">
        ...
        <tr>
          ...
          </select> <span class="font_red">*</span>
          </td>
        </td>
        </tr>
        <tr>
