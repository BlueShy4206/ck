...
<table width="184" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        <td align="center"><img src="images/member_region.png" width="184" height="36" /></td>
      </tr>
    ...
    <table width="184" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
      <tr>
        <td align="center" bgcolor="#FFFFFF"><img src="images/member_region.png" width="184" height="36" /></td>
      </tr>
      <tr>
   ...
   <div align="center"> <?PHP //<a href="shopcart_show.php"><img src="images/btn_car1.gif" width="84" height="18" border="0" /></a>?> </div> 
    ...
    <table width="184" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="184" height="40" align="center" bgcolor="#FFFFFF"><img src="images/exam_information.png" width="184" height="40" /></td>
      </tr>
      <tr>
        <td height="15" align="center" valign="middle" bgcolor="#FFFFFF">
        </td>
      </tr>
      <tr>
...
if($_SESSION['MM_Username'] != NULL){	
			?>
        <a href="examAdd1.php"><img src="images/sign.png" width="115"  height="67" /></a><br />
 ...
 <!--<a href="menberis1.php">--><img src="images/sign.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
  			...
  			<img src="images/104schedule.png" />
  			</td>
            <tr>
           <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
            <img src="images/flow.png"  />
  			...
  			<? if($_SESSION["MM_UserGroup"]=='member'){?>
   <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >         
            <a href="progress.php">
            <img src="images/progress_check.png"  /></a> <?php } ?>
      ...
      <tr>
        ...
        <a href="examOutprint.php"><img src="images/print.png" /></a>
        </td>
      </tr>
      <tr>
        <td height="32" align="center" valign="middle" bgcolor="#FFFFFF">
        ...
        <a href="duble_check.php"><img src="images/duble_check.png" /></a>
          <tr>
        <td height="32" align="center" valign="middle" bgcolor="#FFFFFF">
        <img src="images/certificate_ok2.png" onclick="ShowLink()" />
        <? }?>
                </td>               
      </tr>
    </table>
