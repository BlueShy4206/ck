...
<div id="main111" background= "#FFFFFF">
 ...
 if($colname_web_member != "-1"){
  ...
  <p><font size="5px"><?php echo (date('Y')-1911); ?>年第二梯次師資生學科知能評量
  	<br/>報名表</div></font></p></td><!-- add by coway 2016.8.9 -->
     ...
     <table width="750" border="0" cellspacing="0" cellpadding="9" >
        ...
        <tr>
            ...
            <td  align="center" style="font-size:12px; background-color: #E8E8E8; border-style:solid; border-color:#000000; border-width:1px; ">緊急連絡<br>人姓名</td> <td  align="center" style="font-size:12px; background-color: #FFFFFF; border-style:solid; border-color:#000000; border-width:1px; " colspan="2">
            <?php echo $row_web_examinee['contact'];?>            
            </td>
            <td  align="center" style="font-size:12px; background-color: #E8E8E8; border-style:solid; border-color:#000000; border-width:1px; ">緊急連絡<br>人電話</td> <td  align="center" style="font-size:12px; background-color: #FFFFFF; border-style:solid; border-color:#000000; border-width:1px; " colspan="1"><?php echo $row_web_examinee['contact_ph'];?></td>
        </tr>
     ...
     <table width="750" height="500" border="0" cellspacing="0" cellpadding="7">
     <tr>
     ...
     <tr>
        <td width="50" align="center" style="font-size:12px; background-color: #E8E8E8; border-style:solid; border-color:#000000; border-width:1px; "rowspan="2">備註</td> <td width="550" align="life" style="font-size:12px; background-color: #FFFFFF; border-style:solid; border-color:#000000; border-width:1px; " colspan="6" rowspan="2">本表請於<u>105年10月4日（星期二）前</u>填妥並貼妥國民身分證及學生證（務必加蓋當學期的註冊章，或提供在學證明書）的正、反面影本1份或相關表件，以掛號寄達本試務行政組收（40306臺中市西區民生路140號教育樓5樓教師專業能力測驗中心），逾期視同未完成報名（以郵局郵戳為憑）。【所有資料依個資法辦理】
			備註：<u>應考人所填寫相關資料，將與就讀學校師培單位進行確認<b>(報考資格(三)(四)之應考人)</b>，經查核呈報資料如有虛報不實者，將取消應考資格</u>。</td>
...
?>            <input name="date" type="hidden" id="date" value="<? echo date("Y-m-d H:i:s");?>" />
	  ...
	  <p><font size="5px" ><?php echo (date('Y')-1911); ?>年第二梯次師資生學科知能評量<br></div></font></p> <!---->
	  </td> 
	  </tr>  
	  <tr>
      ...
      <tr><td width="750" rowspan="3" align="left" style="font-size:22px; border-width:5px; border-style:solid;border-color:#000000;">
      ...
      <br><div align="center"><font size="5px" ><BIG><span style="font-weight:bolder;"><?php echo (date('Y')-1911); ?>年第二梯次師資生學科知能評量 試務行政組&nbsp;&nbsp;收</span></BIG></div></font><br></div></td>
      </tr> 
      </table><br>
      <table border="0" width="750"   >
      <tr>
      	<td colspan="2"><div align="left" style="font-family:標楷體;"><font size="4px" ><b>郵寄報名表件截止時間：105年10月4日(星期二)止，以郵局郵戳為憑</b>
      	</font></div></td>
      </tr> 
      ...
      <tr><td colspan="2"><div align="left" style="font-family:標楷體;"><font size="3px" >應考資格： ☐已完成國民小學師資類科教育實習之學生</font></div></td>
      <tr><td colspan="2"><div align="left" style="font-family:標楷體;"><font size="3px" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☐刻正進行國民小學師資類科教育實習之學生</font></td></tr>
      <tr><td colspan="2"><div align="left" style="font-family:標楷體;"><font size="3px" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☐具備國民小學師資類科資格之在學師資生</font></td></tr>
      <tr><td colspan="2"><div align="left" style="font-family:標楷體;"><font size="3px" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☐通過國民小學師資類科資格甄選之在學生</font></td></tr>
      <tr><td colspan="2"><div align="left" style="font-family:標楷體;"><font size="3px" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;☐尚未通過國民小學師資類科資格甄選之在學生</font></td></tr>
      </tr>
      </table><br>
