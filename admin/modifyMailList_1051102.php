...
// 			var RPNm = document.getElementById("RP").value;
			...
			document.form1.subject.value=<?php echo date("Y")-1911;?>+"年第二梯次師資生學科知能評量_應考人補正資料通知_"+Today.getFullYear()+ " 年 " + (Today.getMonth()+1) + " 月 " + Today.getDate() + " 日";
			document.form1.mailBody.value="您好：<br>\n"+
				"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;謝謝您報名參與<span style='color:#00f;'><u>"+<?php echo date("Y")-1911;?>+"</u></span>年第<span style='color:#00f;'>二</span>梯次<span style='color:#00f;'>師資生</span>學科知能評量，您所郵寄的報名相關表件我們已收到。</p><br>\n"+
			"<p>一、依本報名簡章所載：本中心自<span style='color:#00f;'><u>105/10/13</u></span>起開始公告應考人需補正資料，並於<span style='color:#00f;'><u>10/20</u></span>報名補件截止，以郵局郵戮為憑，逾期不予受理。</p>\n"+
			...
			"<p>&nbsp;&nbsp;※請於<span style='color:#00f;'><u>105/10/20</u></span>報名補件截止日前(郵局郵戮為憑)將需補正之表件，郵寄至本中心。</p></td></tr></table>";
...
// 			var RPNm = document.getElementById("RP").value;
			var PRStr=GetCheckedValue("RPc");
			 ...
			 var PRString="";
			 for (var i=0;i<arrChk.length;i++){ PRString+="<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+(i+1)+".<span style='color:#f00;'><u>"+arrChk[i]+"</u></span></p>"; }   
			document.form1.subject.value=<?php echo date("Y")-1911;?>+"年第二梯次國民小學教師「自然領域」學科知能評量_應考人補正資料通知_"+Today.getFullYear()+ " 年 " + (Today.getMonth()+1) + " 月 " + Today.getDate() + " 日";
			document.form1.mailBody.value="您好：<br>\n"+
			...
			"<p>您的報考資格為<span style='color:#f00;'><u>"+$('#id').val()+"</u></span>， 所需補正之表件如下：</p>\n\n"+
			"<table align='left' border='1' cellpadding='1' cellspacing='1' style='width: 700px;'><tr><td>"+PRString+
			"<p>&nbsp;&nbsp;※請於<span style='color:#00f;'><u>105/11/8</u></span>報名補件截止日前(郵局郵戮為憑)將需補正之表件，郵寄至本中心。</p></td></tr></table>";
		}
