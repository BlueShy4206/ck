...
define("yes_error", "admin_banner2Add.php");
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO banner (banner_type, banner_pic) VALUES (%s, %s)",
  ...
  <div align="center">
    ...
    <table width="760" border="0" cellspacing="0" cellpadding="0" background="../images/back11_2.gif">
      <tr>
        ...
        <td width="725" align="left" background="../images/board04.gif">&nbsp; <span class="font_black">新增<img src="../images/icon_swf.gif" width="16" height="16" />廣告</span></td>
        <td width="10" align="right"><img src="../images/board05.gif" width="10" height="28" /></td>
      </tr>
    </table>
    <table width="760" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td height="20" align="left" class="board_add">SWF 廣 告：</td>
        ...
        <label>
          ...
          <br />
          <span class="font_red">
          **限制檔案格式為：SWF，檔案尺寸不能超過300KB，超連結請直接製作在檔案中!!</span></span></td>
      </tr>
    </table>
    <label>
      <br />
    ...
    <input name="banner_type" type="hidden" id="banner_type" value="2" />
    <br />
    <br />
