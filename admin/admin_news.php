...
$query_web_news = "SELECT * FROM news ORDER BY news_top DESC, news_id DESC";
  ...
  <div id="admin_main2">
    ...
    <?php if ($totalRows_web_news > 0) { // Show if recordset not empty ?>
      <table width="555" border="0" cellspacing="0" cellpadding="0">
        <?php do { ?>
          <tr>
            <td width="20" align="center" class="board_add"><?php echo $row_web_news['news_id']; ?></td>
            <td width="50" height="30" align="center" class="board_add"><?php /*START_PHP_SIRFCIT*/ if ($row_web_news['news_type']=="news"){ ?>
            ...
            <td width="385" align="left" class="board_add">&nbsp; <?php echo $row_web_news['news_title']; ?>&nbsp; ...<?php echo $row_web_news['news_date']; ?>
            <?php 
		  //若為置頂公告則增添TOP圖示
		  /*START_PHP_SIRFCIT*/ if ($row_web_news['news_top']==1){ ?>
            ...
            <td width="100" align="center" class="board_add">[ <a href="admin_newsUpdate.php?news_id=<?php echo $row_web_news['news_id']; ?>">編輯</a> ]&nbsp; [ <a href="admin_newsDel.php?news_id=<?php echo $row_web_news['news_id']; ?>&amp;news_pic=<?php echo $row_web_news['news_pic']; ?>&amp;news_download=<?php echo $row_web_news['news_download']; ?>&amp;delSure=1" onclick="tfm_confirmLink('確定刪除本資料?');return document.MM_returnValue">刪除</a> ]</td>
          </tr>
