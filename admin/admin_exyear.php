...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	$startday=$_POST["startday"];//$_POST["startyear"]."-".$_POST["startmonth"]."-".$_POST["startday"];
	$endday=$_POST["endday"];//$_POST["endyear"]."-".$_POST["endmonth"]."-".$_POST["endday"];
	$printtime=$_POST["printtime"];//$_POST["printyear"]."-".$_POST["printmonth"]."-".$_POST["printday"];
	$ndateday=$_POST["ndateday"];//$_POST['ndateyear']."-".$_POST['ndatemonth']."-".$_POST['ndateday'];
	$cdateday=$_POST["cdateday"];//$_POST['cdateyear']."-".$_POST['cdatemonth']."-".$_POST['cdateday'];
	$sdateday=$_POST["sdateday"];//$_POST['sdateyear']."-".$_POST['sdatemonth']."-".$_POST['sdateday'];
	$edateday=$_POST["edateday"];//$_POST['edateyear']."-".$_POST['edatemonth']."-".$_POST['edateday'];
    ...
    <table width="540" border="0" align="center" cellpadding="5" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left" class="board_add"><p class="table_lineheight"/>
        	<input type="text" name="startday" id="startday">
		 	<input type="button" value="Cal" onclick="displayCalendar(startday,'yyyy-mm-dd',this)">
      ...
      <tr>
        ...
        <td align="left" class="board_add"><p class="table_lineheight"/>
        	<input type="text" name="endday" id="endday">
		 	<input type="button" value="Cal" onclick="displayCalendar(endday,'yyyy-mm-dd',this)">
      ...
      <td height="20" align="right" class="board_add">准考證列印時間：</td>
        <td align="left" class="board_add"><p class="table_lineheight"/>
			...
			<input type="button" value="Cal" onclick="displayCalendar(printtime,'yyyy-mm-dd',this)">
      ...
      <tr>
        <td height="20" align="right" class="board_add"><p>北區：</p>
          ...
          <p>東區：</p></td>
        <td align="left" class="board_add"><p class="table_lineheight"/>
        	<input type="text" name="ndateday" id="ndateday">
			<input type="button" value="Cal" onclick="displayCalendar(ndateday,'yyyy-mm-dd',this)">
        <!--<select name="ndateyear" id="ndateyear">
             <option>年</option>
               <script language="javascript" type="text/javascript">
                   var watch=new Date();
                   var thisYear=watch.getFullYear();
          ...
          <p>
          <input type="text" name="cdateday" id="cdateday">
		  <input type="button" value="Cal" onclick="displayCalendar(cdateday,'yyyy-mm-dd',this)">
          <!--<select name="cdateyear" id="cdateyear">
             <option>年</option>
               <script language="javascript" type="text/javascript">
                   var watch=new Date();
                   var thisYear=watch.getFullYear();
          ...
          <p>
          <input type="text" name="sdateday" id="sdateday">
		  <input type="button" value="Cal" onclick="displayCalendar(sdateday,'yyyy-mm-dd',this)">
          ...
          <p>
          <input type="text" name="edateday" id="edateday">
		  <input type="button" value="Cal" onclick="displayCalendar(edateday,'yyyy-mm-dd',this)">
