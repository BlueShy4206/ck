...
// 					"AND examinee.exarea LIKE '%".$_POST['exarea']."%' ";
		if($_POST['allow'] != ""){	$sql_s = $sql_s ." AND examinee.allow='".$_POST['allow']."'";
		}
		if($_POST['exarea'] != ""){	$sql_s = $sql_s ."AND examinee.exarea = '".$_POST['exarea']."' " ;
		}
					
			$sql_s = $sql_s ."ORDER BY exarea,exarea_note,examinee.no ASC";//AND examinee.date>'2016/11/1' AND examinee.allow='Y'
// 		echo $sql_s;
// 		die();
