...
// $text = "人文與藝術學院
// 		應用歷史學系碩士在職專班";
// $High_college = explode("\n",$text)[0];
// $High_dep = explode("\n",$text)[1];
// $text2 = "";
// $High_college2 = explode(" ",$text2)[0];
// $High_dep2 = explode(" ",$text2)[1];

// echo "High_college=".$High_college."<br>";
// echo "High_dep=".$High_dep."<br>";
// echo "High_college2=".$High_college2."<br>";
// echo "High_dep2=".$High_dep2."<br>";
// die();
//	---------------------------------------------
	...
	foreach($sheetData as $key => $col){
		...
		if($key != 1){		
			...
			if($totalRows_web_member == 0){
				...
				$High_dep = explode(" ",$col['T'])[1];
				$Sec_college = explode(" ",$col['W'])[0];
				$Sec_dep = explode(" ",$col['W'])[1];
// 				echo "High_college=".$High_college."<br>";
// 				echo "High_dep=".$High_dep."<br>";
// 				echo "Sec_college=".$Sec_college."<br>";
// 				echo "Sec_dep=".$Sec_dep."<br>";
// 				die();
				//學位,畢業.就學中 註記
				if(explode("\n",$col['U'])[1] == "已畢業")//最高學位
				{
