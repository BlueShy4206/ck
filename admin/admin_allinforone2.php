...
function getRandNewPassword()
  ...
  $password=getRandNewPassword();
	...
	$insertSQL = sprintf("INSERT INTO forfirst (id, password, seepass, name, school, Student_ID, Department, Grade, sex, exarea, category) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($Ticket, "text"),
                       GetSQLValueString(md5($password), "text"),
					   GetSQLValueString($password, "text"),
					   GetSQLValueString(mb_convert_encoding($score[2],"utf-8","big5"), "text"),
					   ...
					   GetSQLValueString(mb_convert_encoding($score[9],"utf-8","big5"), "text"),
