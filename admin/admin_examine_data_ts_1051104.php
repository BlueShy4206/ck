...
// 			$objPHPExcel->getActiveSheet()->setCellValue('AM1' ,"錄取順序"); //錄取順序
		...
		$sql_s="SELECT examinee.*, allguide.note as exam_school FROM examinee, allguide WHERE allguide.up_no='EA2' 
					...
					ORDER BY exarea,exarea_note,examinee.no ASC"; // and examinee.allow='Y' AND allguide.no in ('S')  AND allguide.data2='22'  AND exarea='Central', AND allguide.no='C'  AND allow='Y'
