  ...
  <p><font size="+3" >准考證</font> </p>
   ...
   <!--  <table width="600" border="0" cellspacing="0" cellpadding="0" >
      ...
      <?php $str=split("," , $row_web_examinee['category']);
       ...
       <tr height="20"><td style="font-size:16px; background-color: #e6e6fa;">評量領域</td><td style="font-size:16px; background-color: #e6e6fa;">時間</td><td style="font-size:16px; background-color: #e6e6fa;">執行項目</td></tr>
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" > 
    	<tr><br>
          ...
          <p><font size="+2" ><strong><p>師資生學科知能評量試場規則(簡略版)</p></strong></font></p>
            </td>
        </tr>
        <tr>  
