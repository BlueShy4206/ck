  ...
  <p><font size="+3" ><strong>考試通知</strong></font> </p>
   ...
   <!--  <table width="600" border="0" cellspacing="0" cellpadding="0" >
      ...
      <table  width="600" border="0" cellspacing="0" cellpadding="0" >
      	...
      	<tr>
      		<td align="left" style="font-size:12px;">(教育部106年8月31日臺教師（二）字第1060125357號函委託國立臺中教育大學辦理)</td><!-- (教育部105年○月○○日臺教師（二）字第○○○○○○○○○○號函委託國立臺中教育大學辦理)待確認後改！ -->
      	</tr>
      </table>
      ...
      <?php $str=split("," , $row_web_examinee['category']);
       ...
       <tr height="20"><td style="font-size:16px; background-color: #e6e6fa;"><center><b>評量領域</b></center></td><td style="font-size:16px; background-color: #e6e6fa;"><b><center>時間</b></center></td><td style="font-size:16px; background-color: #e6e6fa;"><b><center>執行項目</b></center></td></tr>
       <tr class="board_add"><td rowspan="3"><center>數學領域</center></td><td><center>10:00〜10:05</center></td><td>應考人入場</td></tr>
