...
<script>
	...
	function SaveAlert(){
		...
		if(input_id==3 ){
			...
			if(Student_ID.value== "" && $('input:radio[name="Grade"]:checked').val() != '7' ){
				swal("學號未填。");
				window.event.returnValue=false;
			}
		}
...
//    echo "儲存時間2=".substr(($row_web_examinee['date']),0,19)."<br>";
  ...
  $row_web_new['endday']=$row_web_new['endday']." 17:00:00";
  //判斷手機
  $phone_num= array();
         ...
         <tr>
          ...
          <label>本評量報考資格分為四類，其錄取順序如下：<br>
							<label class="radio-inline">
	          					<input type="radio" name="exam_id" id="radio1" value="1"  onclick="popIdMsg();"  Checked/>
