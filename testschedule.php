...
<?php include("leftzone.php")?>
  ...
  <!-- <div id="main3"> -->
    ...
    <img src="images/testschedule.png" width="520" height="30" /><br />
    <table width="520" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <!-- <tr>
            <td>
                <img src="images/student.jpg" style="width: 122px;">
            </td>
        </tr> -->
        <tr>
            <td>
                <a class="venobox" href="images/testschedule_s1.png"><img src="images/testschedule_s1.png" alt="image alt" style="width: 520px;"/></a>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <a class="venobox" href="images/testschedule_s2.png"><img src="images/testschedule_s2.png" alt="image alt" style="width: 520px;"/></a>
            </td>
        </tr>
    </table>
    <div>
        <br /><img src="images/line.png" style="width: 520px;"/>
    </div>
<br />
    <table width="520" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr>
        <td>
            <a class="venobox" href="images/testschedule_t1.png"><img src="images/testschedule_t1.png" alt="image alt" style="width: 520px;"/></a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <a class="venobox" href="images/testschedule_t2.png"><img src="images/testschedule_t2.png" alt="image alt" style="width: 520px;"/></a>
        </td>
    </tr>
    <!-- <img src="images/notopen.jpg" style="height: 260px;"> -->
