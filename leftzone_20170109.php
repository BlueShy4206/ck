...
<!-- 國小教師連結 -->
 ...
 <!--<a href="menberis1.php">--><img src="images/sign_t.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        ...
        <?php if(date('y-m-d')>= $publishDate){//國小日程表?>
  			<a href="./file/20160927221237.pdf"><img src="images/105schedule_t.png" /></a>
  		<?php }else { ?> <img src="images/105schedule_t.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){//國小報名流程?>
         	<a href="./file/20160927221256.pdf"><img src="images/flow_t.png"  /></a>
 ...
 <!--<a href="menberis1.php">--><img src="images/sign.png" width="115"  height="67" /></a><? }?>
      ...
      <tr>
        ...
        <?php if(date('y-m-d')>= $publishDate){//師資生日程表?>
  			<a href="./file/20160905102520.pdf"><img src="images/105schedule.png" /></a>
  		<?php }else { ?> <img src="images/105schedule.png" /><? }?>
  		</td>
      <tr>
         <td height="36" align="center" valign="middle" bgcolor="#FFFFFF" >
         <?php if(date('y-m-d')>= $publishDate){//師資生報名流程?>
         	<a href="./file/20160905102543.pdf"><img src="images/flow.png"  /></a>
...
<div id="dlg" class="easyui-dialog" closed="true" title="簡章下載" style="width:200px;height:150px;padding:10px"
						...
						">
	<a href="./file/20160905102553.pdf" class="easyui-linkbutton" >師資生簡章</a><a href="./file/20160927221313.pdf" class="easyui-linkbutton" >國小教師簡章</a>
</div>
