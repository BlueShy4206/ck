...
// 	die();
    ...
    echo "<script>console.log('77')</script>";
    ...
    echo "<script>console.log('88')</script>";
	...
	echo "<script>console.log('-------------------')</script>";
	echo "<script>console.log('3:'+".substr(($_POST['exarea'][0]),0,1).")</script>";
	echo "<script>console.log('4:'+".$row_web_allguide2['no'].")</script>";
	if(substr(($_POST['exarea'][0]),0,1) == $row_web_allguide2['no']){
		// print_r($_POST['exarea']);
		echo "<script>console.log('1:'+".$totalRows_web_search2.")</script>";
		echo "<script>console.log('2:'+".(int)$row_web_allguide2['data3'].")</script>";
