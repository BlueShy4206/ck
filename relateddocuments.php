...
<table width="520" border="0" cellspacing="0" cellpadding="0">
    ...
    <!-- <img src="images/assessmentdes.png" width="520" height="30" />-->
    <br />
    <table width="520" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <?PHP if($_GET["level"] == "0"){ ?>
            <tr>
              ...
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105450.pdf">
                  107年第二梯次師資生學科知能評量-身心障礙應考人特殊考場服務申請表.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105503.pdf">
                  107年第二梯次師資生學科知能評量-身心障礙應考人申請應考服務診斷證明書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905165515.pdf">
                  107年第二梯次師資生學科知能評量-身心障礙應考人申請應考切結書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
        <?PHP }else{ ?>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              ...
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105549.pdf">
                  107年第二梯次國小教師自然領域學科知能評量-身心障礙應考人特殊考場服務申請表.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105559.pdf">
                  107年第二梯次國小教師自然領域學科知能評量-身心障礙應考人申請應考服務診斷證明書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105606.pdf">
                  107年第二梯次國小教師自然領域學科知能評量-身心障礙應考人申請應考切結書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905165618.pdf">
                  107年第二梯次國小教師自然領域學科知能評量-在職證明書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
            <tr>
              <td width="20" height="25" align="right" class="underline1">‧</td>
              <td width="30" class="underline1">
               </td>
              <td width="300" align="left" class="underline1"> &nbsp; <a href="file/20180905105627.pdf">
                  107年第二梯次國小教師自然領域學科知能評量-報考資格(二)申請應考切結書.pdf</a>&nbsp; &nbsp; </td>
            </tr>
        <?PHP } ?>
    </table>
