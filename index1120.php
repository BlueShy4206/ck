...
$query_web_news = "SELECT news_id, news_title, news_type, date_format(news_date,'%Y-%m-%d') news_date, news_top FROM news WHERE news_date <= now() ORDER BY news_top DESC, news_id DESC";
...
<div id="content">
    <img src="images/news.png" width="540" height="48" /><br />
