...
function CalConv()
 ...
 document.write( "<span class=d><strong>今天是西元" + SolarYear + "年 " + SolarMonth + "月" + SolarDate + "日</strong></span>&nbsp;&nbsp;" );
       document.write( "<span class=d>農曆 " + LunarMonth + "月 " + LunarDate + "日</span>" );

       //document.write( "<span class=d>&nbsp;煞" + Location + " 沖" + Animal + Age + "歲</span><br>" );                
        document.write( "<span class=d>&nbsp;煞" + Location + " 沖" + Animal + Age + "歲</span>" );
