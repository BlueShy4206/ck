        ...
        seajs
          .config({
              preload : [
                ...
                /MSIE/i.test(navigator.userAgent) && /^(localhost|10\.10\.4\.43)$/.test(location.host) ? 'https://getfirebug.com/firebug-lite.js' : ''
              ]
          })
          .use('//img.scupio.com/ec/mallimg/RTBMallBanner/JSBanner/MallJS_' + p[0][0].itemMallid + '/160X600/main')
    })
}