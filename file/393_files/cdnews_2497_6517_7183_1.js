(function(window, undefined) {
    ...
    var scriptId = "cdnews_2497_6517_7183_1" + ts4;
    window.Scupio.alive = window.Scupio.alive || {};
    _s.alive[scriptId] = true;
   
    var iw = '160'; var ih = '600'; var pub = 'lQgIGAYpVg=='; var cid = '7183'; var wid = '2497,26,18'; ;
    ...
    var browser = {
        ...
        function loadGeneralAdtype(ts4, iw, ih, cid, wid, pub) {
            var bws = 'm=1&s=0,4,158,598,FFFFFF,20,FFFFFF,3,5,9,2,10,4,0,-1,1,,CM,,,,-1,,8,1,1,0&fs=FFFFFF&shf=http://www.scupio.com&ssf=fsz:11pt,lh:23px,c:0000ff,txd:n&scf=fsz:10pt,lh:20px,c:333333,txd:n&suf=&sif=&pif=90,90,3&si=160,600,1;4;17;20';
            var ic = '#FFFFFF';
        ...
        function loadModalPlayerAdtype(ts4, iw, ih, cid, wid, pub) {
            // player parameters
            var id = ts4;
            var adviewerArg = "&channelid=7183&wid=2497,26,26&PubID=lQgIGAYpVg==";
            var maskwidth = 0;
