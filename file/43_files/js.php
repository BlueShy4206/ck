...
function getWidthid55b8b3d744392() {
...
function getHeightid55b8b3d744392() {
    var ins = [[240, 320],[320, 480], [480, 800], [768, 1024]];
    if (0 == 1) {
        var h = screen.height;
        var w = screen.width;
...
function errid55b8b3d744392() {
    var ps_u = (location.protocol=='https:'?'https://youthwant.apx.appier.net/www/delivery/passback.php':'http://youthwant.apx.appier.net/www/delivery/passback.php');
    var src = ps_u+"?zoneid=138&id=id55b8b3d744392";
    ...
    e.onload = function() {
        ...
        i.scrolling = 'no';
        //adiv.appendChild(i)
        document.getElementById('id55b8b3d744392').appendChild(i);
        var fw = (i.contentWindow || i.contentDocument);
        fw.document.open();
        fw.document.write(this.responseText);
        fw.document.close();
        i.height = getHeightid55b8b3d744392();
        i.width = getWidthid55b8b3d744392();
    }
    e.send();
}
function fireieid55b8b3d744392(data) {
    var x = createXMLHttpRequest();
    var m3_u = (location.protocol=='https:'?'https://youthwant.apx.appier.net/www/delivery/ajs.php':'http://youthwant.apx.appier.net/www/delivery/ajs.php');
    m3_u += '?' + data.toString();
    var i = document.createElement('iframe');
    i.frameBorder = 0;
    i.scrolling = 'no';
...
function fireid55b8b3d744392(data) {
    if (window.FormData === undefined) {
        fireieid55b8b3d744392(data);
        return;
    }
    var x = createXMLHttpRequest();
    var m3_u = (location.protocol=='https:'?'https://youthwant.apx.appier.net/www/delivery/ajs.php':'http://youthwant.apx.appier.net/www/delivery/ajs.php'); 
