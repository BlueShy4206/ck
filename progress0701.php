...
<?php if($totalRows_web_member == 0){ //判斷本次是否有報名 ?>    
  <table width="540" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center" class="font_red2" bgcolor="#FFFFFF">目前尚未報名本次測驗</td>
      </tr>
  </table>
  <?php }else{ ?>
...
if (!(strcmp($val,"4"))) {echo "自然領域";}} ?></td>
        ...
        <tr>
          ...
          <td align="left" class="board_add4"> <a href="examOuttoprint.php"><img src="images/click_to_print.png"  /></a></td>
           <td height="30" align="right" class="board_add4"></td>
        </tr>
        <tr>
          <td height="30" align="right" class="board_add4">資料審查：</td>
          <td align="left" class="board_add4"><?php if($row_web_examinee['allow']=="Y"){
