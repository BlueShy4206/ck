...
IF($_GET['type']=='p'){
	...
	$levelSub=$row_web_news['physical_level'].$row_web_news['level_eng4'];
	$noteScore=$row_web_news['note4'];
}elseif ($_GET['type']=='c'){
	$subjectTest='國語領域';
	$scoreSub=$row_web_news['chinese'];
	$levelSub=$row_web_news['chinese_level'].$row_web_news['level_eng1'];
	$noteScore=$row_web_news['note'];
}elseif ($_GET['type']=='m'){
	$subjectTest='數學領域';
	$scoreSub=$row_web_news['math'];
	$levelSub=$row_web_news['math_level'].$row_web_news['level_eng2'];
	$noteScore=$row_web_news['note2'];
}elseif ($_GET['type']=='s'){
	$subjectTest='社會領域';
	$scoreSub=$row_web_news['social'];
	$levelSub=$row_web_news['social_level'].$row_web_news['level_eng3'];
...
$html = "<table width='500' border='0' cellspacing='0' cellpadding='0' valign='top'>
		<tr>
			<td align='center' colspan='4'><br><p><font size='+3' >104年師資生學科知能評量</font></p></td>
		</tr>
		<tr>
			<td align='center' colspan='4'><p><font size='+2' >成績單  Test Score Report</font> </p></td>
		</tr>
	</table>
	<table width='500' border='1' cellspacing='0' cellpadding='0'>
        <tr>
        	<td width='120' height='10' align='center' style='font-size:18px;'>姓名<br>Name</td>
        	<td width='120' align='center' valign='center' style='font-size:20px;'>$row_web_news[name]</td>
        	<td width='120' height='10' align='center' style='font-size:18px;'>准考證號碼<br>Reg. No.</td>
        	<td width='120' align='center' valign='center' style='font-size:20px;'>$row_web_news[id]</td>
        </tr>
        <tr>
        	<td width='120' height='10' align='center' style='font-size:18px;'>評量科目<br>Test Subject</td>
        	<td align='center' valign='center' style='font-size:20px;'>$subjectTest</td>
        	<td width='120' height='10' align='center' style='font-size:18px;'>測驗成績<br>Test Score</td>
        	<td align='center' valign='center' style='font-size:20px;'>$scoreSub</td>
        </tr>
        <tr>
        	<td height='10' height='10' align='center' style='font-size:18px;'>表現層級 Level</td>
        	<td colspan='3' align='center' valign='center' style='font-size:20px;'>$levelSub</td>
        </tr>
        <tr>
        	<td height='10'  height='10' align='center' style='font-size:18px;'>備註 <br>Remark</td>
        	<td colspan='3' align='center' valign='center' style='font-size:14px;'>$noteScore</td>
        </tr>
	</table>
	<table>
        <tr><td colspan='3' height='70'><span style='font-size: 12px;'>成績效期：成績公布(104年8月1日)起算三年内有效</span></td></tr>
        <tr><td width='120'></td>
			...
			<span style='font-size: 10px;'>(教育部104年7月14日臺教師(二)字第1040091018號委託國立臺中教育大學辦理)
        		<br>地址：臺中市西區民生路140號
				<br>電話：(04)2218-3651
				<br>網站：https://tl-assessment.ntcu.edu.tw</span>
        	</td>
        </tr>
