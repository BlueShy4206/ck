...
class HTML_QuickForm_Renderer_Default extends HTML_QuickForm_Renderer {
	 ...
	 * @param
	 *        	string Error message associated with the element
	 * @access private
	 * @see renderElement()
	 ...
	 * @param
	 *        	string (optional) Name of the element to apply template for
	 * @access public
	 * @return void
	 */
	 ...
	 * @param
	 *        	string Name of the group to apply template for
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The HTML surrounding the header
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The HTML surrounding the form tags
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The HTML surrounding the required note
	 * @access public
	 * @return void
	 */
