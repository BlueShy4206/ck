...
class HTML_QuickForm_Renderer_ArraySmarty extends HTML_QuickForm_Renderer_Array {
	 ...
	 *
	 * @param
	 *        	Smarty reference to the Smarty template engine instance
	 * @param
	 *        	bool true: render an array of labels to many labels, $key 0 to 'label' and the oterh to "label_$key"
	 * @param
	 ...
	 *
	 * @param
	 *        	HTML_QuickForm_header header element being visited
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	HTML_QuickForm_group group being visited
	 * @param
	 ...
	 * @access private
	 * @param
	 *        	HTML_QuickForm_element form element being visited
	 * @param
	 ...
	 * @access private
	 * @param
	 *        	array Array representation of an element
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The element label
	 * @param
	 *        	string The element html rendering
	 * @param
	 *        	boolean The element required
	 * @param
	 *        	string The element error
	 * @see setRequiredTemplate()
	 * @access private
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The required element template
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The element error template
	 * @access public
	 * @return void
	 */
