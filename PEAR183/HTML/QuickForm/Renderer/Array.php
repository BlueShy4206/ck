...
class HTML_QuickForm_Renderer_Array extends HTML_QuickForm_Renderer {
	...
	/**
	 * Number of sections in the form (i.e.
	 * number of headers in it)
	 * 
	 * @var integer
	 */
	var $_sectionCount;
	 ...
	 *
	 * @param
	 *        	mixed element name or array ('element name' => 'style name')
	 * @param
	 *        	string style name if $elementName is not an array
	 * @access public
	 * @return void
	 */
