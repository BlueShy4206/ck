...
class HTML_QuickForm_Renderer_ITStatic extends HTML_QuickForm_Renderer {
	 ...
	 *
	 * @param
	 *        	HTML_Template_IT|HTML_Template_Sigma Template object to use
	 */
	 ...
	 *
	 * @param
	 *        	HTML_QuickForm form object being visited
	 * @access public
	 * @return void
	 */
	 ...
	 * @param
	 *        	string An error message associated with an element
	 * @access public
	 * @return void
	 */
	function renderElement(&$element, $required, $error) {
		...
		if (! empty ( $this->_inGroup )) {
			$varName = $this->_formName . '_' . str_replace ( array (
					'[',
					']' 
			), '_', $name );
	 ...
	 *
	 * @param
	 *        	HTML_QuickForm_element hidden element being visited
	 * @access public
	 * @return void
	 */
