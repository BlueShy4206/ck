...
class HTML_QuickForm_Renderer_QuickHtml extends HTML_QuickForm_Renderer_Default {
	 ...
	 *
	 * @param string $data
	 *        	(optional) Any extra data to put before the end of the form
	 *        	
	 * @access public
	 * @return string
	 */
	 ...
	 *        	(optional) The value of the element. This is only useful
	 ...
	 *
	 * @param
	 *        	HTML_QuickForm_element hidden form element being visited
	 * @access public
	 * @return void
	 */
