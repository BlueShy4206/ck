...
class HTML_QuickForm_Renderer_ITDynamic extends HTML_QuickForm_Renderer {
	 ...
	 *
	 * @param
	 *        	HTML_Template_ITX|HTML_Template_Sigma Template object to use
	 */
	 ...
	 *
	 * @param
	 *        	mixed element name or array ('element name' => 'block name')
	 * @param
	 *        	string block name if $elementName is not an array
	 * @access public
	 * @return void
	 */
