...
class HTML_QuickForm_RuleRegistry {
	 ...
	 * @param string $data1
	 *        	Name of function, regular expression or
	...
	function registerRule($ruleName, $type, $data1, $data2 = null) {
		...
		if ($type == 'regex') {
			...
			$GLOBALS ['_HTML_QuickForm_registered_rules'] [$ruleName] = array (
					strtolower ( get_class ( $data1 ) ),
					null 
			);
		} else {
			// Rule class name
	 ...
	 *        	to be validated
	 * @param mixed $options
	 *        	Options used by the rule
	 * @param mixed $multiple
	 *        	Whether to validate an array of values altogether
	 * @access public
	 ...
	 *
	 * @param
	 *        	array|HTML_QuickForm_element Element(s) the rule applies to
	 * @param
	 *        	string Element name, in case $element is
	 *        	not an array
	 * @param
	 *        	array Rule data
	 * @access public
	 ...
	 * @access private
	 * @param
	 *        	HTML_QuickForm_element element being processed
	 * @param
	 *        	string element's name
	 * @param
	 *        	bool whether to generate JavaScript to reset
	 *        	the value
	 * @param
	 *        	integer value's index in the array (only used for
	 *        	multielement rules)
