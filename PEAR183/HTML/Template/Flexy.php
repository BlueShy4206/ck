...
class HTML_Template_Flexy {
	 ...
	 * @param string $file
	 *        	relative to the 'templateDir' which you set when calling the constructor
	 ...
	 * Used for offline batch compilation (eg.
	 * if your server doesn't have write access to the filesystem).
	 *
	 * @access public
	 * @author Alan Knowles <alan@akbkhome.com>
	 *        
	 ...
	 *        	object to output
	 * @param
	 *        	array HTML_Template_Flexy_Elements (or any object that implements toHtml())
	 * @return none
	 */
	 ...
	 *        	int error type.
	 * @param
	 *        	int an equivalant to pear error return|die etc.
	 *        	
	 ...
	 * @access public
	 * @see HTML_Template_Flexy_Assign::assign() @status alpha
	 */
	function setData() {
	 ...
	 * @return mixed PEAR_Error or true?
	 * @access public
	 * @see HTML_Template_Flexy_Plugin @status alpha
	 */
	function plugin() {
	 ...
	 *
	 * @param
	 *        	optional mixed object to output
	 *        	
	 * @return mixed PEAR_Error or true?
	 * @access public
	 * @see HTML_Template_Flexy::ouptutObject @status alpha
	 */
