...
/**
 * A standard HTML Tag = eg.
 * Table/Body etc.
 *
 * @abstract This is the generic HTML tag
...
class HTML_Template_Flexy_Token_Tag extends HTML_Template_Flexy_Token {
	...
	/**
	 * postfix tokens
	 * used to add code to end of tags "<xxxx>here....children ..
	 * <close tag>"
	 *
	 * @var array
	 * @access public
	...
	/**
	 * prefix tokens
	 * used to add code to beginning of tags TODO "here<xxxx>....children ..
	 * <close tag>"
	 *
	 * @var array
	 * @access public
