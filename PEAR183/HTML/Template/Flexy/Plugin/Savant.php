...
class HTML_Template_Flexy_Plugin_Savant {
	 ...
	 *        
	 * @param string $href
	 *        	The URL for the resulting <a href="">...</a> tag.
	 *        	
	 * @param string $text
	 *        	The text surrounded by the <a>...</a> tag set.
	 *        	
	 * @param string $extra
	 *        	Any "extra" HTML code to place within the <a>
	 *        	opening tag.
	 *        	
	 * @return string
	 */
	 ...
	 *        
	 * @param string $name
	 *        	The HTML "name=" value for the checkbox.
	 *        	
	 * @param mixed $value
	 *        	The value of the checkbox if checked.
	 *        	
	 * @param mixed $selected
	 *        	Check $value against this; if they match,
	 *        	mark the checkbox as checked.
	 *        	
	 * @param string $set_unchecked
	 *        	If null, this will add no HTML to the
	 ...
	 *        	
	 * @param string $extra
	 *        	Any "extra" HTML code to place within the
	 *        	checkbox element.
	 *        	
	 * @return string
	 *
	 */
	function checkbox($name, $value, $selected = null, $set_unchecked = null, $extra = null) {
		$html = '';
	 ...
	 *        
	 * @param string $name
	 *        	The HTML "name=" value of all the checkbox
	 ...
	 *        	
	 * @param string $sep
	 *        	The HTML text to place between every checkbox
	 *        	in the set.
	 *        	
	 * @param string $extra
	 *        	Any "extra" HTML code to place within the
	...
	$name, $options, $selected = array(), $set_unchecked = null, $sep = "<br />\n", $extra = null) {
	 ...
	 *        
	 * @param int $iteration
	 *        	The iteration number for the cycle.
	 *        	
	 * @param array $values
	 *        	The values to cycle through.
	 *        	
	 * @param int $repeat
	 *        	The number of times to repeat a cycle value.
	 *        	
	 * @return string
	 *
	 */
	...
	function dateformat($datestring, $format = false) {
		if ($format === false) {
			$format = isset ( $this->flexy->options ['plugin.dateformat'] ) ? $this->flexy->options ['plugin.dateformat'] : '%d %b %Y';
		}
		if (trim ( $datestring ) == '') {
			return '';
		}
	...
	function numberformat($number, $dec = false, $point = false, $thousands = false) {
		...
		$dec = ($dec !== false) ? $dec : (isset ( $this->flexy->options ['plugin.numberformat.decimals'] ) ? $this->flexy->options ['plugin.numberformat.decimals'] : 2);
		$point = ($point !== false) ? $point : (isset ( $this->flexy->options ['plugin.numberformat.point'] ) ? $this->flexy->options ['plugin.numberformat.point'] : '.');
		$thousands = ($thousands !== false) ? $thousands : (isset ( $this->flexy->options ['plugin.numberformat.thousands'] ) ? $this->flexy->options ['plugin.numberformat.thousands'] : ',');
	 ...
	 *        
	 * @param string $src
	 *        	The image source as a relative or absolute HREF.
	 *        	
	 * @param string $link
	 *        	Providing a link will make the image clickable,
	 ...
	 *        	
	 */
	function image($src, $alt = null, $border = 0, $width = null, $height = null) {
		$size = '';
		...
		if (is_null ( $width ) && is_null ( $height )) {
			...
			if (substr ( strtolower ( $src ), 0, 7 ) == 'http://' || substr ( strtolower ( $src ), 0, 8 ) == 'https://') {
				...
				// local file system
				$root = isset ( $GLOBALS ['HTTP_SERVER_VARS'] ['DOCUMENT_ROOT'] ) ? $GLOBALS ['HTTP_SERVER_VARS'] ['DOCUMENT_ROOT'] . '/' : '';
			}
		...
		// done!
		return '<img src="' . $src . '"' . $alt . $border . $size . ' />';
	}
	 ...
	 *        
	 * @param string $href
	 *        	The HREF leading to the JavaScript source
	 *        	file.
	 *        	
	 * @return string
	 *
	...
	function javascript($href) {
		return '<script language="javascript" type="text/javascript" src="' . $href . '"></script>';
	}
	 ...
	 *        
	 * @param array $options
	 *        	An associative array of key-value pairs; the
	 *        	key is the option value, the value is the option lable.
	 *        	
	 * @param mixed $selected
	 *        	A string or array that matches one or more
	 ...
	 *        
	 * @param string $name
	 *        	The HTML "name=" value of all the radio <input>s.
	 *        	
	 * @param array $options
	 *        	An array of key-value pairs where the key is the
	 ...
	 *        	A comparison string; if any of the $option
	 ...
	 *        	
	 * @param string $sep
	 *        	The HTML text to place between every radio
	 *        	button in the set.
	 *        	
	 * @return string
	 *
	 */
	function radios($name, $options, $checked = null, $set_unchecked = null, $sep = "<br />\n", $extra = null) {
		$html = '';
	 ...
	 *        
	 * @param string $href
	 *        	The HREF leading to the stylesheet file.
	 *        	
	 * @return string
	 *
	 */
	 ...
	 *        	
	 * @param string $text
	 *        	The initial value of the textarea element.
	 *        	
	 * @param int $tall
	 *        	How many rows tall should the area be?
	 *        	
	 * @param mixed $wide
	 *        	The many columns wide should the area be?
	 *        	
	 * @param string $extra
	 *        	Any "extra" HTML code to place within the
	 *        	checkbox element.
