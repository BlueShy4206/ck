...
class HTML_Template_Flexy_Compiler {
	 ...
	 *
	 * @param
	 *        	array options only ['compiler'] is used directly
	 *        	
	...
	function is_a($obj, $class) // which f***wit depreciated is_a....
{
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy that is requesting the compile
	 ...
	 *
	 * @param
	 *        	string PHP code to append to compiled
	 *        	
	 * @return string to be output
	 * @access public
	 */
