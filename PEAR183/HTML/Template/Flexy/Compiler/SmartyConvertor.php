...
class HTML_Template_Flexy_Compiler_SmartyConvertor extends HTML_Template_Flexy_Compiler {
	 ...
	 *
	 * @param
	 *        	object The core flexy object.
	 * @param
	 *        	string optionally a string to compile.
	 *        	
	 ...
	 *
	 * @param
	 *        	string the contents of the smarty template
	 *        	
	 ...
	 *
	 * @param
	 *        	string the inside of the smart tag
	 *        	
	 ...
	 *
	 * @param
	 *        	string the key value part of the tag..
	 *        	
