...
class HTML_Template_Flexy_Compiler_Flexy extends HTML_Template_Flexy_Compiler {
	...
	/**
	 * Flag indicating compiler is inside {_( ....
	 * )_} block, and should not
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_*
	 *        	
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Else
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	...
	function toStringElse($element) {
		...
		if ($element->pullState () === false) {
			return $this->appendHTML ( "<font color=\"red\">Unmatched {else:} on line: {$element->line}</font>" );
		}
		$element->pushState ();
	...
	function toStringEnd($element) {
		...
		// if the state it is pulling is a if...
		if ($element->pullState () === false) {
			return $this->appendHTML ( "<font color=\"red\">Unmatched {end:} on line: {$element->line}</font>" );
		}
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_EndTag
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Foreach
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	...
	function toStringForeach($element) {
		...
		$ret = 'if ($this->options[\'strict\'] || (' . 'is_array(' . $loopon . ')  || ' . 'is_object(' . $loopon . '))) ' . 'foreach(' . $loopon . " ";
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_If
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	 ...
	 * 
	 * @param
	 *        	object HTML_Template_Flexy_Token_Method|Var
	 *        	
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Method
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	...
	function toStringMethod($element) {
		...
		if (($object == 'GLOBALS') && $GLOBALS ['_HTML_TEMPLATE_FLEXY'] ['currentOptions'] ['globalfunctions']) {
			// we should check if they something weird like: GLOBALS.xxxx[sdf](....)
			$var = $method;
		} else {
			$prefix = 'if ($this->options[\'strict\'] || (isset(' . $var . ') && method_exists(' . $var . ", '{$method}'))) " . $prefix;
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Processing
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Text
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Cdata ?
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
	 ...
	 *
	 * @param
	 *        	mixed preferably.. string to store
	 *        	
	 * @return none
	 * @access public
	 */
	...
	function translateString($string) {
		...
		$pofile = $this->options ['textdomainDir'] . '/' . $this->options ['locale'] . '/LC_MESSAGES/' . $this->options ['textdomain'] . '.po';
	 ...
	 *
	 * @param
	 *        	object HTML_Template_Flexy_Token_Tag
	 *        	
	 * @return string string to build a template
	 * @access public
	 * @see toString*
