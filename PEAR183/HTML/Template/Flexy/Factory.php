...
class HTML_Template_Flexy_Factory {
	...
	/**
	 * fromArray - builds a set of elements from a key=>value array (eg.
	 * DO->toArray())
	 * the second parameter is an optional HTML_Element array to merge it into.
	 *
	 *
	 * @param
	 *        	array key(tag name) => value
	 * @param
	 *        	optional array key(tag name) => HTML_Element
	 *        	
	 ...
	 *
	 * @param
	 *        	array of HTML_Element's
	 * @param
	 *        	array key(tag name) => error
	 * @param
	 *        	string sprintf error format..
	 *        	
	 * @return array Array of HTML_Elements
	 * @access public
	 */
	...
	/**
	 * freeze - freeze's an element.
	 * - just copies the value to the override.
	 ...
	 *
	 * @param
	 *        	array (return by referencekey(tag name) => HTML_Element
	 *        	
	 * @return array Array of HTML_Elements
	 * @access public
	 */
