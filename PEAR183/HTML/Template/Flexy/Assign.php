...
class HTML_Template_Flexy_Assign {
	 ...
	 * @access public
	 *        
	 * @param string|array|object $args[0]
	 *        	This param can be a string, an
	 ...
	 *        	
	 * @param mixed $args[1]
	 *        	If $args[0] is an array or object, $args[1]
	...
	function assign($args) {
		...
		return HTML_Template_Flexy::raiseError ( "invalid type sent to assign, " . print_r ( $args, true ), HTML_TEMPLATE_FLEXY_ASSIGN_ERROR_INVALIDARGS );
	}
	 ...
	 *        
	 * @param string $name
	 *        	The template token-name for the reference.
	 *        	
	 * @param
