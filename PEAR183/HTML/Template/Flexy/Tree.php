...
class HTML_Template_Flexy_Tree {
	 ...
	 * 'filename' => filename of file being parsed.
	 * (for error messages.)
	...
	function tokenize($data) {
		...
		while ( $t = $tokenizer->yylex () ) {
			...
			if ($t == HTML_TEMPLATE_FLEXY_TOKEN_ERROR) {
				return HTML_Template_Flexy::raiseError ( array (
	...
	/**
	 * Match the opening and closing tags eg.
	 * </B> is the closer of <B>
	 *
	...
	/**
	 * Locates Flexy:startchildren etc.
	 * if it is used.
