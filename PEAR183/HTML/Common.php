...
class HTML_Common {
	 ...
	 * @param
	 *        	string Attribute value (will be set to $name if omitted)
	 * @access public
	 */
	...
	/**
	 * Abstract method.
	 * Must be extended to return the objects HTML
	 *
	 * @access public
	 * @return string
	 * @abstract
	 ...
	 *
	 * @param
	 *        	string New charset to use. Omit if just getting the
