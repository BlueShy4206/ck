...
class HTML_Form {
	 ...
	 *
	 * @param string $action
	 *        	the string naming file or URI to which the form
	 *        	should be submitted
	 * @param string $method
	 *        	a string indicating the submission method
	 *        	('get' or 'post')
	 * @param string $name
	 *        	a string used in the <form>'s 'name' attribute
	 * @param string $target
	 *        	a string used in the <form>'s 'target' attribute
	 * @param string $enctype
	 *        	a string indicating the submission's encoding
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 *        	in the element (example: 'id="foo"')
	 * @return void
	 *
	 * @access public
	 */
	function HTML_Form($action, $method = 'get', $name = '', $target = '', $enctype = '', $attr = '') {
		$this->action = $action;
		$this->method = $method;
		$this->name = $name;
		$this->fields = array ();
	 ...
	 *
	 * @param boolean $bool
	 *        	TRUE to use $_GET/$_POST for the default,
	 ...
	 *
	 * @param boolean $bool
	 *        	TRUE to escape, FALSE to disable escaping
	 *        	
	 * @return void
	 *
	 * @see HTML_Form::setDefaultFromInput()
	 ...
	 *
	 * @param string $name
	 *        	the string used in the 'name' attribute
	 * @param string $title
	 *        	the string used as the label
	 * @param mixed $default
	 *        	a default value for the element
	 * @param int $size
	 *        	an integer used in the 'size' attribute
	 * @param int $maxlength
	 *        	an integer used in the 'maxlength' attribute
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 *        	in the element (example: 'id="foo"')
	 * @param string $thattr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayText(), HTML_Form::displayTextRow(),
	 *      HTML_Form::returnText(), HTML_Form::returnTextRow()
	 */
	function addText($name, $title, $default = null, $size = HTML_FORM_TEXT_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'text',
				$name,
				$title,
	 ...
	 */
	function addPassword($name, $title, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'password',
				$name,
				$title,
	 ...
	 *      HTML_Form::returnPasswordOneRow()
	 */
	function addPasswordOne($name, $title, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'passwordOne',
				$name,
				$title,
	 ...
	 *        	the string used as the label
	 * @param bool $default
	 *        	a bool indicating if item should be checked
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 *        	in the element (example: 'id="foo"')
	 * @param string $thattr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayCheckbox(), HTML_Form::displayCheckboxRow(),
	 *      HTML_Form::returnCheckbox(), HTML_Form::returnCheckboxRow()
	 */
	function addCheckbox($name, $title, $default = false, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'checkbox',
				$name,
				$title,
	 ...
	 *        	a default value for the element
	 * @param int $width
	 *        	an integer saying how many characters wide
	 *        	the item should be
	 * @param int $height
	 *        	an integer saying how many rows tall the
	 *        	item should be
	 * @param int $maxlength
	 *        	an integer used in the 'maxlength' attribute
	 * @param string $attr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayTextarea(), HTML_Form::displayTextareaRow(),
	 *      HTML_Form::returnTextarea(), HTML_Form::returnTextareaRow()
	 */
	function addTextarea($name, $title, $default = null, $width = HTML_FORM_TEXTAREA_WT, $height = HTML_FORM_TEXTAREA_HT, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'textarea',
				$name,
				$title,
	 ...
	 *
	 * @param string $name
	 *        	a string used in the 'name' attribute
	 * @param string $title
	 *        	a string that appears on the button
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 *        	in the element (example: 'id="foo"')
	 * @param string $thattr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displaySubmit(), HTML_Form::displaySubmitRow(),
	 *      HTML_Form::returnSubmit(), HTML_Form::returnSubmitRow()
	 */
	function addSubmit($name = 'submit', $title = 'Submit Changes', $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'submit',
				$name,
				$title,
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayReset(), HTML_Form::displayResetRow(),
	 *      HTML_Form::returnReset(), HTML_Form::returnResetRow()
	 */
	function addReset($title = 'Discard Changes', $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'reset',
				$title,
				$attr,
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displaySelect(), HTML_Form::displaySelectRow(),
	 *      HTML_Form::returnSelect(), HTML_Form::returnSelectRow()
	 */
	function addSelect($name, $title, $entries, $default = null, $size = 1, $blank = '', $multiple = false, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'select',
				$name,
				$title,
	 ...
	 *        	the string used as the label
	 * @param string $value
	 *        	the string used for the item's value
	 * @param bool $default
	 *        	a bool indicating if item should be checked
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayRadio(), HTML_Form::displayRadioRow(),
	 *      HTML_Form::returnRadio(), HTML_Form::returnRadioRow()
	 */
	function addRadio($name, $title, $value, $default = false, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'radio',
				$name,
				$title,
	 ...
	 *        	the string used as the label
	 * @param string $src
	 *        	the string denoting the path to the image.
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayImage(), HTML_Form::displayImageRow(),
	 *      HTML_Form::returnImage(), HTML_Form::returnImageRow()
	 */
	function addImage($name, $title, $src, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'image',
				$name,
				$title,
	 ...
	 *
	 * @param int $i
	 *        	the number of rows to create. Ignored if
	 *        	$title is used.
	 * @param string $title
	 *        	a string to be used as the label for the row
	 * @param string $thattr
	 *        	a string of additional attributes to be put
	 *        	in the <th> element (example: 'class="foo"')
	 * @param string $tdattr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayBlank(), HTML_Form::displayBlankRow(),
	 *      HTML_Form::returnBlank(), HTML_Form::returnBlankRow()
	 */
	function addBlank($i, $title = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'blank',
				$i,
				$title,
	 ...
	 *        	the string used as the label
	 * @param int $maxsize
	 *        	an integer determining how large (in bytes) a
	 *        	submitted file can be.
	 * @param int $size
	 *        	an integer used in the 'size' attribute
	 * @param string $accept
	 *        	a string saying which MIME types are allowed
	 * @param string $attr
	 *        	a string of additional attributes to be put
	 *        	in the element (example: 'id="foo"')
	 * @param string $thattr
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayFile(), HTML_Form::displayFileRow(),
	 *      HTML_Form::returnFile(), HTML_Form::returnFileRow(),
	 *      HTML_Form::returnMultipleFiles()
	 */
	function addFile($name, $title, $maxsize = HTML_FORM_MAX_FILE_SIZE, $size = HTML_FORM_TEXT_SIZE, $accept = '', $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
	 ...
	 *
	 * @access public
	 * @see HTML_Form::display(), HTML_Form::displayPlaintext(), HTML_Form::displayPlaintextRow(),
	 *      HTML_Form::returnPlaintext(), HTML_Form::returnPlaintextRow()
	 */
	function addPlaintext($title, $text = '&nbsp;', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$this->fields [] = array (
				'plaintext',
				$title,
				$text,
	 ...
	 *        	a bool indicating if the form should
	 ...
	 *      HTML_Form::returnText(), HTML_Form::returnTextRow()
	 */
	function displayText($name, $default = null, $size = HTML_FORM_TEXT_SIZE, $maxlength = 0, $attr = '') {
	 ...
	 *      HTML_Form::returnText(), HTML_Form::returnTextRow()
	 */
	function displayTextRow($name, $title, $default = null, $size = HTML_FORM_TEXT_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		print HTML_Form::returnTextRow ( $name, $title, $default, $size, $maxlength, $attr, $thattr, $tdattr );
	}
	 ...
	 *      HTML_Form::returnPassword(), HTML_Form::returnPasswordRow()
	 */
	function displayPassword($name, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '') {
		print HTML_Form::returnPassword ( $name, $default, $size, $maxlength, $attr );
	}
	 ...
	 * @static
	 *
	 * @see HTML_Form::displayPasswordOneRow(), HTML_Form::displayPassword(), HTML_Form::addPassword(),
	 *      HTML_Form::returnPassword(), HTML_Form::returnPasswordRow()
	 */
	 ...
	 * @static
	 *
	 * @see HTML_Form::displayPasswordRow(), HTML_Form::displayPassword(), HTML_Form::addPassword(),
	 *      HTML_Form::returnPassword(), HTML_Form::returnPasswordRow(),
	 *      HTML_Form::returnPasswordOneRow()
	 */
	function displayPasswordOneRow($name, $title, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		print HTML_Form::returnPasswordOneRow ( $name, $title, $default, $size, $maxlength, $attr, $thattr, $tdattr );
	}
	 ...
	 *      HTML_Form::returnTextarea(), HTML_Form::returnTextareaRow()
	 */
	function displayTextarea($name, $default = null, $width = 40, $height = 5, $maxlength = '', $attr = '') {
		print HTML_Form::returnTextarea ( $name, $default, $width, $height, $maxlength, $attr );
	}
	 ...
	 *      HTML_Form::returnTextarea(), HTML_Form::returnTextareaRow()
	 */
	function displayTextareaRow($name, $title, $default = null, $width = 40, $height = 5, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		print HTML_Form::returnTextareaRow ( $name, $title, $default, $width, $height, $maxlength, $attr, $thattr, $tdattr );
	}
	 ...
	 *      HTML_Form::returnSubmit(), HTML_Form::returnSubmitRow()
	 */
	function displaySubmit($title = 'Submit Changes', $name = 'submit', $attr = '') {
	 ...
	 *      HTML_Form::returnSelect(), HTML_Form::returnSelectRow()
	 */
	function displaySelect($name, $entries, $default = null, $size = 1, $blank = '', $multiple = false, $attr = '') {
		print HTML_Form::returnSelect ( $name, $entries, $default, $size, $blank, $multiple, $attr );
	}
	 ...
	 *      HTML_Form::returnMultipleFiles()
	 */
	function displayFile($name, $maxsize = HTML_FORM_MAX_FILE_SIZE, $size = HTML_FORM_TEXT_SIZE, $accept = '', $attr = '') {
	 ...
	 *      HTML_Form::returnMultipleFiles()
	 */
	function displayFileRow($name, $title, $maxsize = HTML_FORM_MAX_FILE_SIZE, $size = HTML_FORM_TEXT_SIZE, $accept = '', $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		print HTML_Form::returnFileRow ( $name, $title, $maxsize, $size, $accept, $attr, $thattr, $tdattr );
	}
	 ...
	 */
	function returnText($name, $default = null, $size = HTML_FORM_TEXT_SIZE, $maxlength = 0, $attr = '') {
	 ...
	 */
	function returnTextRow($name, $title, $default = null, $size = HTML_FORM_TEXT_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$str = " <tr>\n";
		$str .= '  <th ' . $thattr . '>' . $title . "</th>\n";
		$str .= '  <td ' . $tdattr . ">\n   ";
		$str .= HTML_Form::returnText ( $name, $default, $size, $maxlength, $attr );
		$str .= "  </td>\n";
		$str .= " </tr>\n";
	 ...
	 */
	function returnPassword($name, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '') {
	 ...
	 */
	function returnPasswordRow($name, $title, $default = null, $size = HTML_FORM_PASSWD_SIZE, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$str = " <tr>\n";
		$str .= '  <th ' . $thattr . '>' . $title . "</th>\n";
		$str .= '  <td ' . $tdattr . ">\n   ";
		$str .= HTML_Form::returnPassword ( $name, $default, $size, $maxlength, $attr );
		$str .= "   repeat: ";
		$str .= HTML_Form::returnPassword ( $name . '2', $default, $size, $maxlength, $attr );
		$str .= "  </td>\n";
		$str .= " </tr>\n";
	 ...
	 */
	function returnTextarea($name, $default = null, $width = 40, $height = 5, $maxlength = 0, $attr = '') {
	 ...
	 *      HTML_Form::returnTextareaRow(), HTML_Form::addTextarea()
	 */
	function returnTextareaRow($name, $title, $default = null, $width = 40, $height = 5, $maxlength = 0, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$str = " <tr>\n";
		$str .= '  <th ' . $thattr . '>' . $title . "</th>\n";
		$str .= '  <td ' . $tdattr . ">\n   ";
		$str .= HTML_Form::returnTextarea ( $name, $default, $width, $height, $maxlength, $attr );
		$str .= "  </td>\n";
		$str .= " </tr>\n";
	 ...
	 */
	function returnSubmit($title = 'Submit Changes', $name = 'submit', $attr = '') {
		return '<input type="submit" name="' . $name . '"' . ' value="' . $title . '" ' . $attr . "/>\n";
	}
	 ...
	 */
	function returnSelect($name, $entries, $default = null, $size = 1, $blank = '', $multiple = false, $attr = '') {
		...
		foreach ( $entries as $val => $text ) {
			...
			if (! is_null ( $default )) {
				if ($multiple && is_array ( $default )) {
					if ((is_string ( key ( $default ) ) && $default [$val]) || (is_int ( key ( $default ) ) && in_array ( $val, $default ))) {
	 ...
	 */
	function returnSelectRow($name, $title, $entries, $default = null, $size = 1, $blank = '', $multiple = false, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		$str = " <tr>\n";
		$str .= '  <th ' . $thattr . '>' . $title . "</th>\n";
		$str .= '  <td ' . $tdattr . ">\n";
		$str .= HTML_Form::returnSelect ( $name, $entries, $default, $size, $blank, $multiple, $attr );
		$str .= "  </td>\n";
		$str .= " </tr>\n";
	...
	function returnRadio($name, $value, $default = false, $attr = '') {
		return '<input type="radio" name="' . $name . '"' . ' value="' . $value . '"' . ($default ? ' checked="checked"' : '') . ' ' . $attr . "/>\n";
	}
	 ...
	 * @since Method available since Release 1.1.0
	 */
	function returnRadioRow($name, $title, $value, $default = false, $attr = '', $thattr = HTML_FORM_TH_ATTR, $tdattr = HTML_FORM_TD_ATTR) {
		return " <tr>\n" . '  <th ' . $thattr . '>' . $title . "</th>\n" . '  <td ' . $tdattr . ">\n   " . HTML_Form::returnRadio ( $name, $value, $default, $attr ) . "  </td>\n" . " </tr>\n";
	}
	...
	function returnImage($name, $src, $attr = '') {
		return '<input type="image" name="' . $name . '"' . ' src="' . $src . '" ' . $attr . "/>\n";
	}
	 ...
	 *      HTML_Form::returnMultipleFiles()
	 */
	function returnFile($name = 'userfile', $maxsize = HTML_FORM_MAX_FILE_SIZE, $size = HTML_FORM_TEXT_SIZE, $accept = '', $attr = '') {
	 ...
	 *        	submitted file can be.
	 * @param int $files
	 *        	an integer of how many file inputs to show
	 * @param int $size
	 *        	an integer used in the 'size' attribute
	 * @param string $accept
	 *        	a string saying which MIME types are allowed
	 ...
	 *      HTML_Form::addFile()
	 */
	function returnMultipleFiles($name = 'userfile[]', $maxsize = HTML_FORM_MAX_FILE_SIZE, $files = 3, $size = HTML_FORM_TEXT_SIZE, $accept = '', $attr = '') {
		$str = '<input type="hidden" name="MAX_FILE_SIZE" value="';
		$str .= $maxsize . "\" />\n";
	 ...
	 *        	if present, a <caption> is added to the table
	 * @param string $capattr
	 *        	a string of additional attributes to be put
	...
	function display($attr = '', $caption = '', $capattr = '') {
		...
		foreach ( $this->fields as $field_index => $field ) {
			...
			if ($this->_default_from_input && $this->_default_params [$type] && $field [$this->_default_params [$type]] === null && array_key_exists ( $name, $input )) {
				// Grab the user input from $_GET/$_POST.
				if ($this->_escape_default_from_input) {
					$field [$this->_default_params [$type]] = htmlspecialchars ( $input [$name] );
				} else {
		...
		for($i = 0; $i < sizeof ( $hidden ); $i ++) {
			$this->displayHidden ( $this->fields [$hidden [$i]] [1], $this->fields [$hidden [$i]] [2], $this->fields [$hidden [$i]] [3] );
		}
