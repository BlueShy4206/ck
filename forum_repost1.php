...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formPost")) {
  ...
  $insertGoTo = "forum_detial.php?forum_id=" . $row_web_forum['forum_id'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="main">
  ...
  <form id="formPost" name="formPost" method="POST" action="<?php echo $editFormAction; ?>">
    ...
    <table width="555" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td colspan="2" class="board_add"><span class="font_black">原文作者：</span><?php echo $row_web_forum['forum_username']; ?><br />          
          <label>
            <textarea name="re_quote" id="re_quote" cols="65" rows="5"><?php echo $row_web_forum['forum_content']; ?></textarea>
          </label>
          <br />
  ...
  <input name="re_quoteUser" type="hidden" id="re_quoteUser" value="<?php echo $row_web_forum['forum_username']; ?>" />
  <input name="re_quoteDate" type="hidden" id="re_quoteDate" value="<?php echo $row_web_forum['forum_date']; ?>" />
</label></td>
      </tr>
      <tr>
        <td width="82" height="30" class="board_add">回覆標題：</td>
        <td width="468" align="left" class="board_add"><label>
          <input name="re_title" type="text" id="re_title" value="Re:<?php echo $row_web_forum['forum_title']; ?>" size="60" />
