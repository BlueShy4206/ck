      ...
      <table width="555" border="0" cellspacing="0" cellpadding="0">
        <?php do { ?>
          <tr class="board_add3">
            ...
            <td width="210" height="30" align="left" class="board_add3"><?php /*START_PHP_SIRFCIT*/ if ($row_web_forum['forum_top']=="Y"){ ?>
                <img src="images/icon_forum_top.gif" width="38" height="16" hspace="2" />
                <?php } /*END_PHP_SIRFCIT*/ ?>
              <a href="forum_viewCount.php?forum_id=<?php echo $row_web_forum['forum_id']; ?>"><?php echo $row_web_forum['forum_title']; ?></a>
            ...
            <td width="109" align="center" class="board_add3"><span class="font_mini"><?php echo $row_web_forum['forum_username']; ?><br />
              <?php echo date("Y-m-d",$row_web_forum['forum_date']); ?><br />
            </span></td>
            <td width="92" align="center" class="board_add3"><?php echo $row_web_forum['forum_replies']; ?>/ <?php echo $row_web_forum['forum_view']; ?></td>
            <td width="119" align="center" class="board_add3"><span class="font_mini"><?php echo $row_web_forum['forum_lastman']; ?><br />
              <?php echo date("Y-m-d",$row_web_forum['forum_lastdate']); ?><br />
            </span></td>
          </tr>
          <?php } while ($row_web_forum = mysql_fetch_assoc($web_forum)); ?>
      </table>
      <table width="555" border="0" cellspacing="0" cellpadding="0">
        <tr>
