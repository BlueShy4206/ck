...
<div id="main111" background= "#FFFFFF">
 ...
 if($colname_web_member != "-1"){
  ...
  <p><font size="5px"><?php echo (date('Y')-1911); ?>年第一梯次國民小學師資類科
...
?>            <input name="date" type="hidden" id="date" value="<? echo date("Y-m-d H:i:s");?>" />
	  ...
	  <p><font size="5px" ><?php echo (date('Y')-1911); ?>年第一梯次國民小學師資類科師資生學科知能評量<br></div></font></p> <!---->
	  </td> 
	  </tr>  
	  <tr>
      ...
      <br><div align="center"><font size="4px" ><BIG><span style="font-weight:bolder;"><?php echo (date('Y')-1911); ?>年第一梯次國民小學師資類科師資生學科知能評量 試務行政組&nbsp;&nbsp;收</span></BIG></div></font><br></div></td>
      </tr> 
      </table><br>
      <table border="0" width="770"   >
      <tr>
      	<td colspan="2"><div align="left" style="font-family:標楷體;"><font size="4px" ><b>郵寄報名表件截止時間：106年3月28日(星期二)止，以郵局郵戳為憑</b>
      	</font></div></td>
      </tr> 
