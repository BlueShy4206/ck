...
<div id="main111" background= "#FFFFFF">
 ...
 if(strtotime($row_web_new['printtime']) <= strtotime(date('Y-m-d H:i:s')) && strtotime(date('Y-m-d')) <= strtotime($exdate) && $times1 == $row_web_new['times'] && $row_web_examinee['allow'] == "Y" &&($times2 == date('Y') or $times2 == $exyear)){ //判斷否符合列印准考證的資格
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0" >
    <td align="center">
  <p><font size="+2" ><?php echo (date('Y',$dateline)-1911); ?>年第二梯次師資生學科知能評量
  </font></p>
  <p><font size="+3" >准考證</font> </p>
   ...
   <!--  <table width="600" border="0" cellspacing="0" cellpadding="0" >
      ...
      <table  width="600" border="0" cellspacing="0" cellpadding="0" > 
      	...
      	<tr>
      		<td align="left" style="font-size:12px;">(教育部105 年9 月2 日臺教師（二）字第1050124204 號函委託國立臺中教育大學辦理)</td><!-- (教育部105年○月○○日臺教師（二）字第○○○○○○○○○○號函委託國立臺中教育大學辦理)待確認後改！ -->
      	</tr>
      </table>
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" > 
    	<tr>
          ...
          <p><font size="+2" ><strong><?php echo (date('Y',$dateline)-1911); ?>年第二梯次師資生學科知能評量試場規則</strong></font></p>
            </td>
        </tr>
        <tr>  
