    ...
    <tr>
      ...
      <?php do { ?>
        <tr>
          ...
          <td width="50" align="center" class="underline1"> <?php if($row_web_news['score_cpoint'] == 0){echo " ";}else{echo $row_web_news['score_cpoint'];} ?> </td>
          <td width="50" align="center" class="underline1"> <?php if($row_web_news['score_mpoint'] == 0){echo " ";}else{echo $row_web_news['score_mpoint'];} ?> </td>
          <td width="50" align="center" class="underline1"> <?php if($row_web_news['score_spoint'] == 0){echo " ";}else{echo $row_web_news['score_spoint'];} ?> </td>
          <td width="50" align="center" class="underline1"> <?php if($row_web_news['score_ppoint'] == 0){echo " ";}else{echo $row_web_news['score_ppoint'];} ?> </td>
          <td align="center" class="underline1">
          <?php if($row_web_news['score_id'] !=""){ ?>
          	<img class="img-40" src="images/icon_print.png" onclick="$('#dlg').dialog('open')" />
          	  <div id="dlg" class="easyui-dialog" title="選擇成績單列印科目" style="width:400px;height:200px;padding:10px"
						data-options="
							buttons: [{
								text:'Print',
								iconCls:'icon-ok',
				...
				<form id="login-form" method="get" action="resultsPDF.php">
					...
					　<?php if ($row_web_news['score_mpoint'] != 0){echo '<option value="m">數學</option>';}?>
          ...
          <td align="center" class="underline1"><img class="img-40" src="images/icon_mail.png" onclick="ShowLink2()" /></td>
        </tr>
